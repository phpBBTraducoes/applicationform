...
$lang = array_merge($lang, array(
	'APPLICATION_SUBJECT'			=> 'Solicitação de %s',
	...
	'APPLICATION_SEND'				=> 'O seu pedido foi enviado para os administradores deste forum. eles decidirao sobre seu pedido nos proximos dias.',
	...
	'APPLICATION_POSITION'			=> 'Posição que você gostaria de ter',
	'APPLICATION_WHY'				=> 'Por que devemos escolher você?',
	'APP_NOT_COMPLETELY_FILLED'		=> 'Você precisa preencher todos os campos no formulario.',
	'APP_COMPLETE_NAME_WHY'			=> 'Você deve fornecer um nome e por que você quer ser considerado.',
	'ADD_ATTACHMENT_EXPLAIN'		=> 'Anexe um arquivo para que nos ajude na decisao do seu pedido.',
	'ADD_ATTACHMENT_REQ'			=> '<strong>É necessario anexar um arquivo para que voce seja considerado para a posicao desejada</strong>.',
